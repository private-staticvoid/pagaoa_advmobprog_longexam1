...
class _PostCardState extends State<PostCard> {
  ...
  Future<void> toggleLike() async {
    final nowLiked = await LocalStorageService.togglePostLike(
      widget.post!.id,
    );
    if (!mounted) return;
    setState(() {
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.comment_outlined, size: 18.sp, color: textColor),
                        SizedBox(width: 4.w),
                        CustomFont(
                          text: 'Comment',
                          fontSize: 12.sp,
                  ...
                  Row(
                    children: [
                      Icon(Icons.remove_red_eye_outlined, size: 18.sp, color: textColor),
                      SizedBox(width: 4.w),
                      CustomFont(
                        text: '${post.views}',
                        fontSize: 12.sp,
